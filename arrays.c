/*
    ...
    -- Esencialmente el programa recibe in arreglo de números enteros y
    los organiza de menor a mayor. Es ineficiente porque no puede determinar
    de forma autónoma si el arreglo ya esta ordenado y en consecuencia detenerse,
    el programa va a continuar imprimiendo el arreglo hasta recorrerlo por completo. --
    Helliot May 28, 2024
*/
